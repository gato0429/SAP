/********************************************************************************
** Form generated from reading UI file 'formmoneda.ui'
**
...
#ifndef UI_FORMMONEDA_H
#define UI_FORMMONEDA_H
...
public:
    ...
    void setupUi(QWidget *FormMoneda)
    {
        if (FormMoneda->objectName().isEmpty())
            FormMoneda->setObjectName(QStringLiteral("FormMoneda"));
        FormMoneda->resize(442, 352);
        layoutWidget = new QWidget(FormMoneda);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 10, 391, 82));
        ...
        tabWidget = new QTabWidget(FormMoneda);
        tabWidget->setObjectName(QStringLiteral("tabWidget"));
        tabWidget->setGeometry(QRect(20, 100, 382, 236));
        QFont font;
...
""));
        ...
        verticalLayout_2->addWidget(ButtonModificar, 0, Qt::AlignBottom);
        ...
        retranslateUi(FormMoneda);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(FormMoneda);
    } // setupUi

    void retranslateUi(QWidget *FormMoneda)
    {
        FormMoneda->setWindowTitle(QApplication::translate("FormMoneda", "Form", 0));
        label_6->setText(QApplication::translate("FormMoneda", "Icono", 0));
        label_4->setText(QApplication::translate("FormMoneda", "Marca", 0));
        LabelImage->setText(QApplication::translate("FormMoneda", "Imagen", 0));
        label_3->setText(QApplication::translate("FormMoneda", "Imagen", 0));
        label->setText(QApplication::translate("FormMoneda", "Codigo:", 0));
        ButtonArchivoImagen->setText(QApplication::translate("FormMoneda", "...", 0));
        label_2->setText(QApplication::translate("FormMoneda", "Nombre:", 0));
...
namespace Ui {
    class FormMoneda: public Ui_FormMoneda {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FORMMONEDA_H
