/********************************************************************************
** Form generated from reading UI file 'formmodelo.ui'
**
...
#ifndef UI_FORMMODELO_H
#define UI_FORMMODELO_H
...
public:
    ...
    void setupUi(QWidget *FormModelo)
    {
        if (FormModelo->objectName().isEmpty())
            FormModelo->setObjectName(QStringLiteral("FormModelo"));
        FormModelo->resize(400, 300);
        gridLayout = new QGridLayout(FormModelo);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setContentsMargins(-1, 0, -1, -1);
        label_6 = new QLabel(FormModelo);
        ...
        LabelImage = new QLabel(FormModelo);
        ...
        tabWidget = new QTabWidget(FormModelo);
...
""));
        ...
        retranslateUi(FormModelo);

        tabWidget->setCurrentIndex(0);


        QMetaObject::connectSlotsByName(FormModelo);
    } // setupUi

    void retranslateUi(QWidget *FormModelo)
    {
        FormModelo->setWindowTitle(QApplication::translate("FormModelo", "Form", 0));
        label_6->setText(QApplication::translate("FormModelo", "Icono", 0));
        label_4->setText(QApplication::translate("FormModelo", "Marca", 0));
        LabelImage->setText(QApplication::translate("FormModelo", "Imagen", 0));
        label_3->setText(QApplication::translate("FormModelo", "Imagen", 0));
        label->setText(QApplication::translate("FormModelo", "Codigo:", 0));
        ButtonArchivoImagen->setText(QApplication::translate("FormModelo", "...", 0));
        label_2->setText(QApplication::translate("FormModelo", "Nombre:", 0));
...
namespace Ui {
    class FormModelo: public Ui_FormModelo {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_FORMMODELO_H
