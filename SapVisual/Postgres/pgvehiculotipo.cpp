...
PgVehiculoTipo::PgVehiculoTipo()
{

}

bool PgVehiculoTipo::Borrar(VehiculoTipo valor)
{
    QSqlQuery query;
...
bool PgVehiculoTipo::Actualizar(VehiculoTipo Antiguo, VehiculoTipo Nuevo)
{
    QSqlQuery query;
...
VehiculoTipo PgVehiculoTipo::Buscar(VehiculoTipo valor)
{
    QString consulta;
    ...
    bool flag=true;
    VehiculoTipo* resp=new VehiculoTipo();
...
QMap<QString, ObjetoMaestro *> *PgVehiculoTipo::BuscarMapa(ObjetoMaestro *valor, QString Extra, CONSULTA tipo)
{
    MapaRepisaGlobal=new QList<ObjetoMaestro*>();

    VehiculoTipo* val=(VehiculoTipo*)(valor);
    QString consulta;
...
qint64 PgVehiculoTipo::ContarConsulta(ObjetoMaestro *valor)
{
    VehiculoTipo* val=(VehiculoTipo*)(valor);
    QString consulta;
...
QSqlQueryModel *PgVehiculoTipo::BuscarTabla(VehiculoTipo valor, QString Extra, CONSULTA tipo)
{
    QString consulta;
