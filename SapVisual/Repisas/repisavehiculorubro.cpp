#include "repisavehiculorubro.h"

RepisaVehiculoRubro::RepisaVehiculoRubro():Repisa()
{
    ActualizarMapa((ObjetoMaestro*)new VehiculoRubro);
}

void RepisaVehiculoRubro::ConsultarBusqueda()
{
    MostrarLabel();
    return;
}

void RepisaVehiculoRubro::GrupoBotonesClick(QAbstractButton *buttonID)
{
    /*Cambia*/
    Dialogo=new FormVehiculoRubro(this);
    Dialogo->move(this->x()+this->width(),this->y()); //siempre igual
    Dialogo->SetObjeto(((VehiculoRubro*)MapaRepisa->value(buttonID->objectName())));
...
void RepisaVehiculoRubro::NuevoClick()
{
    Dialogo=new FormVehiculoRubro(this);
...
void RepisaVehiculoRubro::BuscarClick()
{
...
void RepisaVehiculoRubro::ObtenerConsulta()
{
    QString ord;
  ...
  //  if(GrupoBoton->button(2)->isChecked())
    ...
    Ordenamiento=ord;
    OrderByCampo="codigo";
    VehiculoRubro* ObjetoBusqueda=new VehiculoRubro();
...
void RepisaVehiculoRubro::ObjetosIndependientes()
{
    /*
     * Para el Tool Tip
    */
    QPushButton* pp=new QPushButton(this);
    VehiculoRubro *i=(VehiculoRubro*)(*it);
...
void RepisaVehiculoRubro::ActualizarConsulta()
{
    FabricaLocal=Bd->Fabrica->CrearVehiculoRubro();
    Bd->Fabrica->Conectar();
